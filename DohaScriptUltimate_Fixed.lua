-- DohaScript Ultimate Full Script (Fixed Mobile & Executors Support)
pcall(function()
    local old = (gethui and gethui():FindFirstChild("DohaScriptUltimate")) or game:GetService("CoreGui"):FindFirstChild("DohaScriptUltimate") or game:GetService("Players").LocalPlayer.PlayerGui:FindFirstChild("DohaScriptUltimate")
...
ScreenGui.Name = "DohaScriptUltimate"
...
WMText.Text = "DohaScript | Creator: Doha | FPS: --"
...
local DohaButton = Instance.new("TextButton")
DohaButton.Size = UDim2.new(0, 42, 0, 36)
DohaButton.Position = UDim2.new(0.02, 0, 0.2, 0)
DohaButton.BackgroundColor3 = CFG.Bg
DohaButton.Text = "DOHA"
DohaButton.Font = Enum.Font.Code
DohaButton.TextSize = 12
DohaButton.Active = true
DohaButton.Draggable = true
DohaButton.Parent = ScreenGui
RegBorder(DohaButton)
RegText(DohaButton)
pcall(function() Instance.new("UICorner", DohaButton).CornerRadius = UDim.new(0, 6) end)
...
DohaButton.MouseButton1Click:Connect(function()
...
PresetBtn.Text = "Preset: Doha Blue"
PresetBtn.Font = Enum.Font.Code
PresetBtn.TextSize = 11
RegText(PresetBtn)

local presets = {
    {name = "Doha Blue", color = Color3.fromRGB(0, 150, 255)},
...
-- Конец предоставленного пользователем фрагмента.
